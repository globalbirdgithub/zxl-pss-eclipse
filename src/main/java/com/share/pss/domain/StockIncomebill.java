...
public class StockIncomebill {
	...
	// 一般组合关系使用List
	private List<StockIncomebillItem> stockIncomebillItems = new ArrayList<StockIncomebillItem>();
	...
	public List<StockIncomebillItem> getStockIncomebillItems() {
		return stockIncomebillItems;
	}

	public void setStockIncomebillItems(List<StockIncomebillItem> stockIncomebillItems) {
		this.stockIncomebillItems = stockIncomebillItems;
	}
