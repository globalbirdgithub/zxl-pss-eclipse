...
<body id="particles-js" class="login-layout">
					...
					<div class="login-container">
						<div class="center">
							<h1>
								...
								<span class="red">阿里巴巴</span> 
								<span class="white">后台管理系统</span>
							</h1>
							<h4 class="blue">&copy; 2010-2015 1688.com 版权所有</h4>
						</div>
									...
									<div class="toolbar clearfix">
										...
										<div>
											<a href="#" onclick="show_box('signup-box'); return false;" class="user-signup-link"> 
												注册新用户 <i class="icon-arrow-right"></i>
											</a>
										</div>
									</div>
								</div>
	...
	<!-- 粒子插件 -->
	<script type="text/javascript" src="plugins/particles/particles.js"></script>
	<script type="text/javascript" src="plugins/particles/app.js"></script>
	<script type="text/javascript" src="plugins/particles/stats.js"></script>
	<!-- 智能手机 -->
