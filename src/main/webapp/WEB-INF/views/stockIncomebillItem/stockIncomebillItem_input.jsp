...
<title>StockIncomebillItem页面</title>
</head>
<body>
	<s:debug></s:debug>
		...
		<div class="page-content">
			...
			<div class="row">					       <!-- ===提示：①使用s标签的时候-获取和提交都可以只用name。②不用s标签时-获取需要EL表达式$，提交需要name=== -->
				<div class="col-xs-12">													       <!-- .col-xs-* 针对超小屏幕和中等屏幕设备所定义的类 -->
					<!-- 页面内容开始 -->
					<form id="stockIncomebillItemForm" class="form-horizontal" action="stockIncomebillItem_save.action" role="form" method="post"><!-- form-horizontal将 label标签和控件组水平并排布局 -->
