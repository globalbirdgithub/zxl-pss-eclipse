...
<body>
	...
	<div class="main-content">
		...
		<div class="page-content">
			<div class="row">
				<div class="col-xs-12">
					<div class="table-header">ProductStock列表</div>
					<div class="table-responsive">
						<div id="sample-table-2_wrapper" class="dataTables_wrapper" role="grid">
						
							<div class="row">
								<form action="productStock.action" id="domainForm" method="post">
									<div class="col-sm-4">
										<div>
									...
									<div class="col-sm-8">
										...
										<a class="btn btn-xs btn-pink" href="productStock_input.action">
										...
										<s:else>
											...
											<td>
												<div class="visible-md visible-lg hidden-sm hidden-xs action-buttons">
													<a class="green" href="#" onclick="updateDomain('productStock_input.action?id=${id}')">
														<i class="icon-pencil bigger-130"></i>
													</a> 
													<a class="red" href="#" onclick="deleteDomain('productStock_delete.action?id=${id}',this)">
