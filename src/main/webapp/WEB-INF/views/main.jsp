...
<body>
				...
				<ul class="nav ace-nav">
					...
					<li class="light-blue"><a data-toggle="dropdown" href="#" class="dropdown-toggle"> 
						...
						<ul
							...
							<li><a href="login_logout.action"> <i class="icon-off"></i> 退出
							</a></li>
						</ul></li>
				</ul>
				<!-- /.ace-nav -->
	...
	<div class="main-container" id="main-container">
		...
		<div class="main-container-inner">
						...
						<li>
							...
							<ul class="submenu">
								<s:iterator value="children">
									<li>
										<a href="${pageContext.request.contextPath}/${url}" target="main_right"> 
										<i class="icon-double-angle-right"></i> ${name}
										</a>
									</li>
								</s:iterator>
							</ul>
			...
			<!-- main_right -->
			<iframe src="/main_right.action" id="rightIframe" scrolling="no" marginheight="0" name="main_right" onload="autoHeight();"></iframe>
