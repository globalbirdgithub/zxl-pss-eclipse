...
<body>
		...
		<div class="navbar-container" id="navbar-container">
			<div class="navbar-header pull-left">
				<a href="#" class="navbar-brand"> 
					<small> <i class="icon-leaf"></i>ZXL-PSS-ACE后台管理系统</small>
				</a>
				<!-- /.brand -->
			</div>
			<!-- /.navbar-header -->
	...
	<div class="main-container" id="main-container">
		...
		<div class="main-container-inner">
			...
			<div class="sidebar" id="sidebar">
				...
				<ul class="nav nav-list">
					...
					<li><a href="#" class="dropdown-toggle"> <i
						...
						<ul class="submenu">
							<li>
								<a href="${pageContext.request.contextPath}/employee.action" target="main_right"> 
								<i class="icon-double-angle-right"></i> 员工管理
								</a>
							</li>

							<li>
								<a href="${pageContext.request.contextPath}/department.action" target="main_right"> 
									<i class="icon-double-angle-right"></i>部门管理
								</a>
							</li>
			...
			<!-- main_right -->
			<iframe src="/main_right.action" id="rightIframe" scrolling="no" 
				marginheight="0" name="main_right" onload="autoHeight();"></iframe>
			<!-- 高度自适应 -->
			<script type="text/javascript">
				function autoHeight() {
