...
<!-- 自定义模型js -->
<script type="text/javascript" src="js/model/${domainLower}.js"></script>
<meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
<title>${domain}页面</title>
</head>
<body>
	<s:debug></s:debug>
		...
		<div class="page-content">
			...
			<div class="row">					       <!-- ===提示：①使用s标签的时候-获取和提交都可以只用name。②不用s标签时-获取需要EL表达式$，提交需要name=== -->
				<div class="col-xs-12">													       <!-- .col-xs-* 针对超小屏幕和中等屏幕设备所定义的类 -->
					<!-- 页面内容开始 -->
					<form id="${domainLower}Form" class="form-horizontal" action="${domainLower}_save.action" role="form" method="post"><!-- form-horizontal将 label标签和控件组水平并排布局 -->
